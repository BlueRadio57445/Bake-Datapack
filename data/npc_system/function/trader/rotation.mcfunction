...
execute as @e[type=#minecraft:display_entities,predicate=!npc_system:trader/riding,tag=npc.this,tag=npc.trader_b] run ride @s mount @e[limit=1,type=minecraft:villager,scores={npc.reset=0},tag=npc.this,tag=npc.trader_b]
...
execute as @e[type=#minecraft:display_entities,predicate=!npc_system:trader/riding,tag=npc.this,tag=npc.trader_s] run ride @s mount @e[limit=1,type=minecraft:villager,scores={npc.reset=0},tag=npc.this,tag=npc.trader_s]
