...
execute unless data entity @s data.Dialogue{Quest:1b} unless data entity @s data.Dialogue{NoExit:1b} positioned ~ ~0.5 ~ run function npc_system:common/option/summon_e
