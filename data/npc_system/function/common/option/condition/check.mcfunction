...
execute if data storage npc_system:common Condition{Type:"item"} unless data storage npc_system:common Condition.Value.tests run function npc_system:common/option/condition/item with storage npc_system:common Condition.Value
execute if data storage npc_system:common Condition{Type:"item"} if data storage npc_system:common Condition.Value.tests run function npc_system:common/option/condition/item_tests with storage npc_system:common Condition.Value
