...
execute if entity @a[tag=npc.user,scores={npc.state=3}] positioned ~ ~1.4 ~ on passengers rotated as @s[type=minecraft:marker] rotated ~ 0 run function npc_system:trader/rotation
