...
$execute at @e[limit=1,tag=npc.figure,tag=npc.this] summon minecraft:marker run function npc_system:common/summon/marker {region:"$(region)",npc:"$(npc)"}
execute at @e[limit=1,type=minecraft:text_display,tag=npc.this] summon minecraft:text_display run function npc_system:common/summon/text_display
