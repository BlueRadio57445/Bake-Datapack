...
execute if data entity @e[limit=1,type=minecraft:marker,tag=npc.this] data.Dialogue.Extra.LeaveCommand run function npc_system:common/extra/leave_command_server
...
execute as @e[limit=1,type=minecraft:marker,tag=npc.this] run function npc_system:common/end_1
