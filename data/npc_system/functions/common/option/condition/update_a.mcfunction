...
function npc_system:common/option/condition/check_a
...
execute if score $condition npc.state matches 1 run tag @e[tag=npc.option_a,tag=npc.this] remove npc.invalid
