...
function npc_system:common/option/condition/check_b
...
execute if score $condition npc.state matches 1 run tag @e[tag=npc.option_b,tag=npc.this] remove npc.invalid
