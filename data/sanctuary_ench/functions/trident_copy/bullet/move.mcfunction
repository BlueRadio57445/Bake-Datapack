...
execute unless block ~ ~ ~ #no_collision run function sanctuary_ench:trident_copy/bullet/hit_something

execute positioned ~-0.1 ~-0.1 ~-0.1 as @e[type=#mobs,dx=0] positioned ~-0.8 ~-0.8 ~-0.8 run tag @s[dx=0] add hitten
execute if entity @e[tag=hitten] run function sanctuary_ench:trident_copy/bullet/hit_something
