...
execute if score @s effects.strong_gravity.duration matches 1 run effect give @s minecraft:slowness 1 4 true
execute if score @s effects.strong_gravity.duration matches 1 run effect give @s[type=minecraft:player] minecraft:levitation 1 214 true
