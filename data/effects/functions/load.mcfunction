scoreboard objectives add effects.state dummy
scoreboard objectives add effects.amplifier dummy
scoreboard objectives add effects.duration dummy

scoreboard objectives add effects.bleed.amplifier dummy
