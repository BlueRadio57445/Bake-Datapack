...
execute at @s positioned ^ ^ ^2 as @e[distance=..3,type=#mobs,type=!player] if predicate weapons:sword/rainbow_crystal_sword/hurt run data merge entity @s {Fire:200s}
