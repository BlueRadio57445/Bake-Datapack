#記得改述詞
Changeexecute as @e[tag=weapons_whip_whip1] if predicate weapons:whip/motion unless predicate weapons:whip/onground at @s as @e[sort=nearest,limit=1,type=#mobs] run damage @s 1
