...
scoreboard objectives remove weapons.sword.thief_sword
scoreboard objectives add weapons.sword.thief_sword.using dummy "盜賊短劍使用中"
...
scoreboard objectives remove weapons.sword.thief_sword.duration

data modify storage weapons:sword fat_sword set value {amount:[1.0d,0.0d]}
data modify storage weapons:sword thief_sword set value {damage:0.0d}
