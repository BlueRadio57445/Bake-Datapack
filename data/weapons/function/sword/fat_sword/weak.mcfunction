...
data modify block 0 16 0 Items[0].components."minecraft:attribute_modifiers".modifiers[{id:"weapons:fat_sword"}].amount set from storage weapons:sword fat_sword.amount[1]
data modify block 0 16 0 Items[0].components."minecraft:custom_model_data" set value 0
