...
data modify entity @e[tag=general.attacked,limit=1] Motion set from entity 00000000-0000-0000-0000-000000000000 Pos
tp 00000000-0000-0000-0000-000000000000 0.0 0.0 0.0
damage @e[tag=general.attacked,limit=1] 7 player_attack
