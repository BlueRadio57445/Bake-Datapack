...
execute if score $hunger_cave.monster quest.state matches 1 unless data storage npc_system:common This.Dialogue run function quest:hunger_cave/monster/check_item
#...
