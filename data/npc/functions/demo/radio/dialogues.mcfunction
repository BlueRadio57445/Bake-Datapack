...
data modify storage npc:demo radio.Idle append value {Text:'{"text":"嗝~"}',Duration:1,Rest:{min:10,max:20}}
data modify storage npc:demo radio.Idle append value {Text:'{"text":"嗝~~"}',Duration:2,Rest:{min:3,max:50}}
