...
execute if score @s npc.state matches 3 run data modify storage npc:demo davleek.Normal set from entity @e[limit=1,type=minecraft:marker,tag=npc.this] data.TraderNormal
