...
summon minecraft:armor_stand ~ ~ ~ {Tags:["npc.this","npc.tag","npc.figure","npc.boss.disaster_starver"],Rotation:[90.0f,0.0f],CustomName:'{"text":"Boss - 災厄餓死鬼"}',Invisible:1b,NoBasePlate:1b,NoGravity:1b,Invulnerable:1b,ArmorItems:[{},{},{},{id:"minecraft:player_head",count:1b,components:{"minecraft:profile":{id:[I;-299503430,-1572319709,-1513125856,-2132581038],properties:[{name:"textures",value:"eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvYWE5NzgwYjhiOWZjYjA4ZTgzNzhjNjVmOGY0MzJjYzJhOTM3YTllMGFiMmZkMTllMDE2ZTdiM2RlYWEwYmMwZSJ9fX0="}]}}}]}
