summon husk ~1.5 ~ ~ {Tags:["death_mob_tag","new"],NoAI:1b,DeathLootTable:"",Silent:1b}
summon husk ~1.5 ~ ~1.5 {Tags:["death_mob_tag","new"],NoAI:1b,DeathLootTable:"",Silent:1b}
summon husk ~-1.5 ~ ~ {Tags:["death_mob_tag","new"],NoAI:1b,DeathLootTable:"",Silent:1b}
summon husk ~-1.5 ~ ~-1.5 {Tags:["death_mob_tag","new"],NoAI:1b,DeathLootTable:"",Silent:1b}

effect give @e[tag=death_mob_tag] invisibility infinite 1 true
