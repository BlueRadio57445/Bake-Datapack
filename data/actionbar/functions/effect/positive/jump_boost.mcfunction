...
execute store success score $effect.new actionbar.state unless data storage actionbar:player Data.PositiveEffects[{Id:8}] run data modify storage actionbar:player Data.PositiveEffects append value {Id:8,custom:0b,Icon:'[{"text":"\\uF800"},{"text":"\\uDAFF\\uDFEA"},{"text":"\\uF808"},{"text":"\\uDB00\\uDC01"}]',IconReverse:'{"text":"\\uDAFF\\uDFE9"}'}
