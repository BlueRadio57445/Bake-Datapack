...
execute store success score $effect.new actionbar.state unless data storage actionbar:player Data.PositiveEffects[{Id:6}] run data modify storage actionbar:player Data.PositiveEffects append value {Id:6,custom:0b,Icon:'[{"text":"\\uF800","font":"bake:icon"},{"text":"\\uDAFF\\uDFEA","font":"bake:space"},{"text":"\\uF806","font":"bake:icon"},{"text":"\\uDB00\\uDC01","font":"bake:space"}]',IconReverse:'{"text":"\\uDAFF\\uDFE9","font":"bake:space"}'}
...
data modify storage actionbar:player Data.PositiveEffects[{Id:6}].updated set value 1b
