...
execute store success score $effect.new actionbar.state unless data storage actionbar:player Data.NegativeEffects[{Id:2}] run data modify storage actionbar:player Data.NegativeEffects prepend value {Id:2,custom:0b,Icon:'[{"text":"\\uF800"},{"text":"\\uDAFF\\uDFEA"},{"text":"\\uF802"},{"text":"\\uDB00\\uDC01"}]',IconReverse:'{"text":"\\uDAFF\\uDFE9"}'}
