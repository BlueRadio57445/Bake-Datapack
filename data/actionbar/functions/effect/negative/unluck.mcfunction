...
execute store success score $effect.new actionbar.state unless data storage actionbar:player Data.NegativeEffects[{Id:27}] run data modify storage actionbar:player Data.NegativeEffects prepend value {Id:27,custom:0b,Icon:'[{"text":"\\uF800"},{"text":"\\uDAFF\\uDFEA"},{"text":"\\uF81B"},{"text":"\\uDB00\\uDC01"}]',IconReverse:'{"text":"\\uDAFF\\uDFE9"}'}
