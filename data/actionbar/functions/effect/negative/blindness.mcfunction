...
execute store success score $effect.new actionbar.state unless data storage actionbar:player Data.NegativeEffects[{Id:15}] run data modify storage actionbar:player Data.NegativeEffects prepend value {Id:15,custom:0b,Icon:'[{"text":"\\uF800","font":"bake:icon"},{"text":"\\uDAFF\\uDFEA","font":"bake:space"},{"text":"\\uF80F","font":"bake:icon"},{"text":"\\uDB00\\uDC01","font":"bake:space"}]',IconReverse:'{"text":"\\uDAFF\\uDFE9","font":"bake:space"}'}
...
data modify storage actionbar:player Data.NegativeEffects[{Id:15}].updated set value 1b
