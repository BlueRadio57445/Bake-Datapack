...
execute if score @s actionbar.cooldown.hotbar_target_time <= $gametime general.utils run function actionbar:cooldown/hotbar_end
...
function actionbar:cooldown/hotbar_mask with storage actionbar:player Data.cooldown.hotbar
