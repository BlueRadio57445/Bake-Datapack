...
execute as @a[predicate=actionbar:cooldown/hotbar_time_matched] run function actionbar:cooldown/hotbar_mask_update
execute as @a[predicate=actionbar:cooldown/offhand_time_matched] run function actionbar:cooldown/offhand_mask_update
