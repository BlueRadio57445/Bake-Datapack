...
execute store result score $temp boss run data get entity @e[tag=poison_starver.center,limit=1] Pos[1]
...
function boss:poison_starver/skill2/cast_macro with storage boss:storage macro
