# schedule遞迴
# 分數還是3的時候有執行位置
execute if score $poison_starver boss.count_down matches 3 run title @a[tag=bossfight_77] title {"text": "3"}
execute if score $poison_starver boss.count_down matches 3 at @a[tag=bossfight_77] run playsound minecraft:entity.experience_orb.pickup master @p ~ ~ ~
...
execute if score $poison_starver boss.count_down matches 2 run title @a[tag=bossfight_77] title {"text": "2"}
execute if score $poison_starver boss.count_down matches 2 at @a[tag=bossfight_77] run playsound minecraft:entity.experience_orb.pickup master @p ~ ~ ~

execute if score $poison_starver boss.count_down matches 1 run title @a[tag=bossfight_77] title {"text": "1"}
execute if score $poison_starver boss.count_down matches 1 at @a[tag=bossfight_77] run playsound minecraft:entity.experience_orb.pickup master @p ~ ~ ~

execute if score $poison_starver boss.count_down matches 0 run title @a[tag=bossfight_77] title {"text": "戰鬥開始!"}
...
execute if score $poison_starver boss.count_down matches 0 at @a[tag=bossfight_77] run playsound minecraft:entity.ender_dragon.growl master @p ~ ~ ~
