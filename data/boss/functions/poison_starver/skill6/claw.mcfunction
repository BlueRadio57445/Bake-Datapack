...
execute positioned ~ ~1 ~ rotated ~ 0 run function boss:poison_starver/skill6/particle
execute positioned ~ ~1 ~ rotated ~16 0 run function boss:poison_starver/skill6/particle
execute positioned ~ ~1 ~ rotated ~-16 0 run function boss:poison_starver/skill6/particle
