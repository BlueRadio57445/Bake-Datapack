...
execute as @s[scores={boss.time0=140},tag=!boss.casting] at @s run function boss:poison_starver/ai/random_cast
...
execute as @s[scores={boss.time0=350},tag=!boss.casting] at @s run function boss:poison_starver/ai/random_cast
execute as @s[scores={boss.time0=420},tag=!boss.casting] at @s run function boss:poison_starver/ai/random_cast
execute as @s[scores={boss.time0=10,boss.stage=2},tag=!boss.casting] at @s run function boss:poison_starver/skill8/cast

scoreboard players set @s[scores={boss.time0=490}] boss.time0 0
...
# 第二階段
execute as @s[scores={boss.stage=1,boss.health=..125},tag=!boss.casting] at @s run function boss:poison_starver/skill8/cast
