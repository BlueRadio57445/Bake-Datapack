...
execute as @e[tag=centipede.line_barrage,tag=line3] at @s run tp @s ^ ^ ^-20 facing entity @e[tag=centipede.barrage_datum,tag=line3,limit=1]
execute as @e[tag=centipede.line_barrage,tag=line4] at @s run tp @s ^ ^ ^-20 facing entity @e[tag=centipede.barrage_datum,tag=line4,limit=1]
execute as @e[tag=centipede.line_barrage,tag=line5] at @s run tp @s ^ ^ ^-20 facing entity @e[tag=centipede.barrage_datum,tag=line5,limit=1]
