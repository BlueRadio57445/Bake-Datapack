...
scoreboard players set $net_barrage centipede.ability 0
...
execute as @e[tag=centipede.barrage_datum] at @s if score $barrage_phase centipede.ability matches 1 run function boss:centipede/skill3/net_barrage