...
execute if score $bullet centipede.cd matches 100 run playsound entity.blaze.shoot ambient @a ~ ~ ~ 10 1 1
execute if score $bullet centipede.cd matches 90.. run tag @s remove centipede.shooting
execute if score $bullet centipede.cd matches 100.. run function boss:centipede/skill1/shoot