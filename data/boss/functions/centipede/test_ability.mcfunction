...
execute as 00000000-0000-0000-0000-000000000b00 if entity @s[tag=!centipede.barrage] if score $barrage centipede.cd matches 1000.. run function boss:centipede/skill2/summon_barrage
...
execute as @e[tag=centipede.can_be_attack] at @s if score $bullet centipede.cd matches 110.. run function boss:centipede/skill1/shoot
