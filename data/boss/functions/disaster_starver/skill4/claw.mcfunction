# 執行者、執行位置是災厄餓死鬼
playsound entity.player.attack.sweep master @a[distance=..10]
...
execute rotated ~ 0 positioned ^ ^ ^2.5 as @a[distance=..2.5] run damage @s 6 mob_attack by @e[sort=nearest,limit=1,tag=boss.disaster_starver]