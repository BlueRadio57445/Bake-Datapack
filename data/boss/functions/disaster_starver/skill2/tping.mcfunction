...
execute as @e[tag=disaster_starver.tping] at @s facing entity @e[tag=disaster_starver.random,limit=1] feet run tp @s ^ ^ ^0.5
execute as @e[tag=disaster_starver.tping] at @s if entity @e[tag=disaster_starver.random,distance=..0.6] run function boss:disaster_starver/skill2/end
