...
scoreboard players set @e[type=item_display,tag=new_air_feather] general.object.duration 1200
execute as @e[type=item_display,tag=new_air_feather] store result score @s general.object.init_timestamp run schedule function knowledge:air_feather/init_anmition 2t append
