...
#生成"只會受到爆擊傷害的殭屍"
summon zombie -161 117 942.0 {Tags:["region.hunger_cave.onlycrit","region.hunger_cave.mob","region.hunger_cave.temp"],CustomNameVisible:1b,Health:200f,IsBaby:0b,CustomName:'[{"text":"只會受到爆擊傷害的殭屍","bold":true},{"text":"(0/3)","color":"red","bold":true}]',Attributes:[{Name:"generic.max_health",Base:200}]}
