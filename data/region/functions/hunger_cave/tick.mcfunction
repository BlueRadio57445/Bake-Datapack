...
#開箱偵測
execute positioned -167 98 971 if entity @a[gamemode=adventure,distance=..7] if score $chest1 region.hunger_cave.crit.hp matches 0 unless blocks -167 98 971 -167 98 971 -167 94 971 all run function region:hunger_cave/tutorial/chest1
execute positioned -163 98 947 if entity @a[gamemode=adventure,distance=..7] if score $chest2 region.hunger_cave.crit.hp matches 0 unless blocks -163 94 947 -163 94 947 -163 98 947 all if block -163 96 947 minecraft:redstone_lamp[lit=false] run function region:hunger_cave/tutorial/chest2
execute positioned -252 101 898 if entity @a[gamemode=adventure,distance=..7] if score $chest3 region.hunger_cave.crit.hp matches 0 unless blocks -252 97 898 -252 97 898 -252 101 898 all run function region:hunger_cave/tutorial/chest3
