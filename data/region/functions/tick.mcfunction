...
#新手教學區：
#通道偵測(無開箱生怪)
execute if entity @a[x=-197,y=97,z=996,dx=0,dy=0,dz=0,gamemode=adventure] run data modify entity @e[type=minecraft:zombie,tag=region.hunger_cave.zombie1,limit=1] NoAI set value 0
execute if entity @a[x=-279,y=113,z=898,dx=0,dy=0,dz=0,gamemode=adventure] run data modify entity @e[type=minecraft:creeper,tag=region.hunger_cave.creeper1,limit=1] NoAI set value 0
#爆擊殭屍回血
effect give @e[type=zombie,tag=region.hunger_cave.onlycrit,limit=1] instant_damage 1 127 true
#開箱偵測
