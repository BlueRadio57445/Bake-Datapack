...
data modify storage quest:demo mysterious_stone.Start set value {Texts:['{"text":"喔你來得正好"}','{"text":"創辦人那裡似乎出了點問題"}','{"text":"要求我尋找一個叫做「神奇石頭」的道具"}','{"text":"我記得 ","extra":[{"underlined":true,"text":"測試用末天機器人"},{"text":" 那邊有很多"}]}','{"text":"不過目前我手邊要處理的事太多了"}','{"text":"能請你幫我去跟他拿嗎"}'],Options:[{Option:'{"text":"接受任務"}',React:['{"text":"拜託了!"}'],Extra:{End_Command:"function quest:demo/mysterious_stone/start"}},{Option:'{"text":"拒絕任務"}',React:['{"text":"沒關係"}','{"text":"那我稍後再找時間去跟他拿"}']}],Quest:1b}
...
data modify storage quest:demo mysterious_stone.Ask set value {Texts:['{"text":"神奇石頭?"}','{"text":"我當然有啊"}','{"text":"而且現在特價中喔"}','{"text":"一顆只賣你新台幣一千元--"}','{"text":"--當然是開玩笑的"}','{"text":"按照規定這東西我得直接給你"}','{"italic":true,"text":"不然你以為我有多不想說剛剛是開玩笑的啊"}','{"text":"唉...你就拿去吧"}'],Extra:{End_Command:"function quest:demo/mysterious_stone/give"}}
...
data modify storage quest:demo mysterious_stone.Reward set value {Texts:['{"text":"上次你走得太急了"}','{"text":"請收下這個吧"}'],Extra:{Start_Command:"function quest:demo/mysterious_stone/finish"}}
