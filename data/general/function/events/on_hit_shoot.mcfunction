...
function general:events/on_hit_shoot/check with storage general:utils input

tag @s add this
execute if data storage general:utils Item.id as @e[type=#minecraft:projectiles] run function general:events/on_hit_shoot/projectile
tag @s remove this
...
advancement revoke @s only general:events/on_hit_shoot
