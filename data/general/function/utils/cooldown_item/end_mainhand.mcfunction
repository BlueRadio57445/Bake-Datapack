...
execute if data entity @s SelectedItem.components."minecraft:custom_data".cooldown.command at @s run function general:utils/execute with entity @s SelectedItem.components."minecraft:custom_data".cooldown
data modify storage general:utils Cooldown.Empty.end_command set from entity @s SelectedItem.components."minecraft:custom_data".cooldown.command
