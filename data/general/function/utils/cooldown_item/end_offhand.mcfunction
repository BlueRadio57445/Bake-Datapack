...
execute if data entity @s Inventory[{Slot:-106b}].components."minecraft:custom_data".cooldown.command at @s run function general:utils/execute with entity @s Inventory[{Slot:-106b}].components."minecraft:custom_data".cooldown
