...
data modify storage general:utils Cooldown.Item.command set from entity @s Inventory[{Slot:-106b}].components."minecraft:custom_data".cooldown.end_command
data modify storage general:utils Cooldown.Item.end_command set from entity @s Inventory[{Slot:-106b}].components."minecraft:custom_data".cooldown.end_command
...
item modify entity @s weapon.offhand {function:"minecraft:copy_custom_data",source:{type:"storage",source:"general:utils"},ops:[{source:"Cooldown.Item",target:"cooldown",op:"replace"}]}
