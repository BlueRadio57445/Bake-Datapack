execute store result score $length general.utils run data get entity @s Inventory[{Slot:-106b}].tag.cooldown.length
...
item modify entity @s weapon.offhand general:utils/cooldown_item_start
