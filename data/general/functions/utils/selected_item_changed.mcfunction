# 手持物品冷卻更新
execute as @s[predicate=actionbar:cooldown/hotbar_update] run function actionbar:cooldown/hotbar_check
execute as @s[predicate=actionbar:cooldown/offhand_update] run function actionbar:cooldown/offhand_check
