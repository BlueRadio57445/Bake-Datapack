...
$execute unless data storage general:extra_lore Item.components."minecraft:max_damage" if data storage general:extra_lore equipments[{id:"$(id)"}] run function general:extra_lore/vanilla with storage general:extra_lore equipments[{id:"$(id)"}]
