$data modify storage general:extra_lore Attribute set from storage general:extra_lore Item.tag.AttributeModifiers[{Name:"$(name).$(type)"}]
...
execute store result score $modifier.operation general.extra_lore run data get storage general:extra_lore Attribute.Operation
execute store result score $modifier.amount general.extra_lore run data get storage general:extra_lore Attribute.Amount 10000
...
execute if score $modifier.default general.extra_lore matches 0 if score $modifier.amount general.extra_lore matches 0 run return -1
...
execute if score $modifier.operation general.extra_lore matches 0 if data storage general:extra_lore Modifier{name:"attack_speed",type:"default"} run scoreboard players add $modifier.amount general.extra_lore 40
execute if score $modifier.operation general.extra_lore matches 0 if data storage general:extra_lore Modifier{name:"attack_damage",type:"default"} run scoreboard players add $modifier.amount general.extra_lore 10
