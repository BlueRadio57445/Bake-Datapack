data modify storage general:extra_lore Modifier set value {name:"armor_toughness",type:"default",text:'',operation:0,amount_sign:"",amount_int:0,amount_dec:0,amount_suf:""}
