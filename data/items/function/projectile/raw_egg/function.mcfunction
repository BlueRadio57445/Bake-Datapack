summon minecraft:area_effect_cloud ~ ~ ~ {Tags:["items.raw_egg.cloud","items.new"],Particle:{type:"minecraft:dust",color:[0.75,0.75,0.75],scale:0.5},potion_contents:{custom_effects:[{id:"minecraft:slowness",amplifier:2,duration:21,show_icon:1b,show_particles:0b}]},Duration:200,DurationOnUse:0,Radius:2f,RadiusOnUse:0f,RadiusPerTick:0f,ReapplicationDelay:20}
