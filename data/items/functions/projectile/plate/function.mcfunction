summon minecraft:item ~ ~ ~ {Tags:["items.broken_plate","items.new"],Passengers:[{id:"minecraft:area_effect_cloud",Particle:"minecraft:item minecraft:glass",Effects:[{Id:2,Amplifier:2,Duration:21,ShowIcon:1b,ShowParticles:0b},{Id:26,Amplifier:0,Duration:2,ShowIcon:0b,ShowParticles:0b}],Duration:400,DurationOnUse:0,Radius:2.5f,RadiusOnUse:0f,RadiusPerTick:0f,ReapplicationDelay:20}],PickupDelay:-1s,Item:{id:"minecraft:structure_void",Count:1b,tag:{CustomModelData:0}}}
