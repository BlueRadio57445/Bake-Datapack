summon minecraft:item ~ ~ ~ {Tags:["items.broken_plate","items.new"],Passengers:[{id:"minecraft:area_effect_cloud",Particle:"minecraft:block minecraft:glass",Duration:400,DurationOnUse:0,Radius:2.5f,RadiusOnUse:0f,RadiusPerTick:0f,ReapplicationDelay:20}],PickupDelay:-1s,Item:{id:"minecraft:structure_void",Count:1b,tag:{CustomModelData:0}}}
